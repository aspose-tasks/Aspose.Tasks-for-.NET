...
Namespace WorkingWithProjects.WorkingWithProjectViews
    Public Class ReadSpecificGantChartViewData
        Public Shared Sub Run()
            ...
            Dim project As New Project(dataDir & Convert.ToString("ReadSpecificGantChartViewData.mpp"))

            Dim view As GanttChartView = TryCast(project.Views.ToList()(0), GanttChartView)
            ...
            Console.WriteLine("BottomTimescaleTier.Label:" & DateLabel.DayDi.ToString(), view.BottomTimescaleTier.Label.ToString())
            ...
            Console.WriteLine("MiddleTimescaleTier.Label:" & DateLabel.DayDi.ToString(), view.MiddleTimescaleTier.Label.ToString())
