namespace Aspose.Tasks.Examples.CSharp
{
    ...
    public class ExOutlineCodeCollection : ApiExampleBase
    {
        ...
        public void WorkWithOutlineCodeCollection()
        {
            ...
            var outlineCodeDefinition = new OutlineCodeDefinition
            {
                FieldId = ((int)ExtendedAttributeTask.OutlineCode3).ToString("D"), 
                Alias = "My Outline Code"
            };
            ...
            var codeOne = new OutlineCode
            {
                FieldId = outlineCodeDefinition.FieldId,
                ValueId = 1,
                ValueGuid = value.ValueGuid.ToString("D").ToUpperInvariant()
            };
            ...
            // add a custom outline code definition
            outlineCodeDefinition = new OutlineCodeDefinition
            {
                FieldId = ((int)ExtendedAttributeTask.OutlineCode3).ToString("D"), 
                Alias = "My Outline Code"
            };
            ...
            // create outline code
            var otherValue = new OutlineValue
            {
                Type = OutlineValueType.Text,
                Value = "Val1",
                Description = "Descr1",
